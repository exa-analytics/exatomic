...
console.log(exawidgets);

class UniverseSceneModel extends exawidgets.ThreeSceneModel {
    get defaults() {
      return _.extend({}, exawidgets.ThreeSceneModel.prototype.defaults, {
...
class UniverseSceneView extends exawidgets.ThreeSceneView {
    /*"""
    UniverseView
    ================
    */
...
class UniverseModel extends exawidgets.BaseBoxModel {
    get defaults() {
        return _.extend({}, exawidgets.BaseBoxModel.prototype.defaults, {
              _model_module: "jupyter-exatomic",
              _view_module: "jupyter-exatomic",
...
class UniverseView extends exawidgets.BaseBoxView {
}


class TestUniverseSceneModel extends UniverseSceneModel {
    get defaults() {
        return _.extend({}, UniverseSceneModel.prototype.defaults, {
...
class TestUniverseSceneView extends UniverseSceneView {
    ...
    // render() {
    //
    //     console.log("inside Test Universe Scene View render");
    //     super.render();
    // }
}


class TestUniverseModel extends UniverseModel {
    get defaults() {
        return _.extend({}, UniverseModel.prototype.defaults, {
...
class TestUniverseView extends UniverseView {
