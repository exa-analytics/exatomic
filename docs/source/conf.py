...
project = "exatomic"
copyrite = "Copyright (c) 2015-2022, Exa Analytics Development Team"
...
latex_documents = [(master_doc, "exatomic.tex", "Exatomic Documentation",
...
man_pages = [
    (master_doc, "exatomic", "Exatomic Documentation", [author], 1)
]
