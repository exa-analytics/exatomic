...
#class Output(Parser):
#    """
#    Parser for output text files coming from ADF calculations.
#
#    This parser handles composite output that may contain output from 'DIRAC'
#    and 'ADF' (and possibly other) calculations in a single file.
#
#    Warning:
#        Not all output is parsed.
#    """
#    pass
#
#
