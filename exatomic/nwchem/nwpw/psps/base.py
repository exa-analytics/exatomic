...
"""
import six
from exa.core import ABCBaseMeta, Container


class NWChemPSPMeta(ABCBaseMeta):
    """
    Defines the data objects for :class:`~exatomic.nwchem.nwpw.psps.base.NWChemPSPs`.
    """
    atoms = list


class NWChemPSPs(six.with_metaclass(NWChemPSPMeta, Container)):
    pass
