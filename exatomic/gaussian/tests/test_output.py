...
class TestOutput(TestCase):
    ...
    def setUp(self):
        ...
        self.mam = Output(resource('g09-ch3nh2-631g.out'))
        self.mam2 = Output(resource('g09-ch3nh2-augccpvdz.out'))
    ...
    def test_parse_atom(self):
        ...
        self.mam.parse_atom()
        self.assertEqual(self.mam.atom.shape[0], 7)
    ...
    def test_parse_basis_set(self):
        ...
        self.assertEqual(self.mam.basis_set.shape[0], 32)
    ...
    def test_parse_orbital(self):
        ...
        self.assertEqual(self.mam.orbital.shape[0], 28)
    ...
    def test_parse_momatrix(self):
        ...
        self.assertEqual(self.mam.momatrix.shape[0], 784)
    ...
    def test_parse_basis_set_order(self):
        ...
        self.assertEqual(self.mam.basis_set_order.shape[0], 28)
    ...
    def test_parse_frame(self):
        ...
        self.assertEqual(self.mam.frame.shape[0], 1)
